...
#        if output directory is not created it will create.
        ...
        bounding_boxes_filename = os.path.join('./Bounding_Box', 'bounding_boxes_%05d.txt' 
                                               % random_key)
